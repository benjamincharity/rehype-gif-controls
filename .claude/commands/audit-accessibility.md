...
2. **Provide Evidence/User Scenario**: Illustrate _how_ it manifests in practice (e.g., user tries to tab through a form but cannot reach the submit button).
...
4. **Explain the Security of This Fix** _(if relevant)_: Not always needed for a11y, but if it overlaps with security concerns (like exposing certain dynamic states), clarify.
