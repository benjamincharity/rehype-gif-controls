 ...
 *
 * Modified for rehype-gif-controls:
 * - Updated canvas styling for responsive behavior
 * - Removed absolute positioning in favor of responsive layout
 */
...
<style>
  ...
  @keyframes gif-player__spinner-spin {
    to {transform: rotate(360deg);}
  }

  .gif-player__spinner:before {
    content: '';
    ...
    animation: gif-player__spinner-spin .6s linear infinite;
  }
</style>
<canvas class="gif-player__canvas"></canvas>
<div class="gif-player__spinner"></div>
`;
  ...
  class GifPlayer extends HTMLElement {
    ...
    constructor() {
      ...
      this._canvas = shadowRoot.querySelector('.gif-player__canvas');
